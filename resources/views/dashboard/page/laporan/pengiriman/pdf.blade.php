    ...
    <div class="container">
            ...
            <div class="row">
                <div style="width:40%;float:left;margin-right:70px;">
                    <div class="row">
                        <table class="table">
                            <tr>
                                <th style="text-align: left;">REPORT DELIVERY</th>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">{{ $data_penjualan->Pelanggan->nama_pelanggan }}</td>
                            </tr>
                            <tr>
                ...
                <div style="width:50%;float:left;">
                    <div>
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <tr>
                                 <td>DATE</td>
                                 <td class="border">{{ $data_penjualan->tanggal }}</td>
                            </tr>
                           <tr>
                                <td>PO NUMBER</td>
                                <td class="border">{{ $data_penjualan->no_po }}</td>
                           </tr>
                        </table>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    @endphp     
                        <tr>
                            ...
                            <td class="border">{{ $carbonDate->format('d F Y'); }}</td>
                            <td class="border">{{ $items->total_qty }}</td>
                        </tr>
                    @endforeach
                </tbody>
             </table>
        ...
        <div class="row" style="width:100%;">
            <table class="table" style="width:50%;margin: 10px auto;">
                ...
                <tr>
                    <td style="font-weight: bold;">QTY TELAH DIKIRIM</td>
                    <td class="border">{{ $sumQty }}</td>
                </tr>
                <tr>
                    <td style="font-weight: bold;">SISA QTY</td>
                    <td class="border">{{ $total_qty_penjualan - $sumQty }}</td>
                </tr>
            </table>
        </div>
